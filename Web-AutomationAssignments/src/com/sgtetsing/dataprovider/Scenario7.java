...
public class Scenario7 {
	...
	public static void CreateTask(String ct)
	{
		try
		{                                    
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\'createTasksPopup_createTasksTableContainer\']/table/tbody/tr[1]/td[1]/input")).sendKeys(ct);
			Thread.sleep(4000);
	...
	public Object[][] getCreateTaskDetails()
	{
		return new Object[][] {{"Write test cases"}};
	}
